# Django settings for rpgnetv2 project.
import os
import logging
...
SECRET_KEY = '-l72i)t6a!2(o9b8p)@7ii06)kig)tfgqszy0$&amp;*uoz&amp;hcsb6r'
...
ROOT_URLCONF = 'rpgnetv2.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rpgnetv2.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    BASE_DIR + "rpform/templates",
    BASE_DIR + "rpform/templates/rpform",
)
